...
const ExpenseRevenueDashboard = () => {
  ...
  const yearlyRevenueData = [
    { id: 1, description: 'Basic Membership', amount: 260000, date: '2023-01-01' },
    { id: 2, description: 'Premium Membership', amount: 96000, date: '2023-01-01' },
    { id: 2, description: 'Standard Membership', amount: 196000, date: '2023-01-01' },
  ...
  return (
    <GymPanel>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {activeTab === 'revenue' && (
          <RevenueExpensesTable data={getCurrentData('revenue')} type="revenue" darkMode />
        )}

        {activeTab === 'expenses' && (
          <RevenueExpensesTable data={getCurrentData('expense')} type="expense" darkMode />
        )}
      </div>
    </GymPanel>
  );
