...
const SalaryManagementPage = () => {
  ...
  const openAddEditForm = (employee: any) => {
    ...
    <GymPanel>
      <div className="p-6">
        <Modal
          ...
          title={selectedEmployee ? "Edit Salary" : "Add Salary"}
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {employees.map((employee: any) => (
            <div
              key={employee.id}
              className="bg-gray-800 p-4 rounded-lg shadow-md hover:shadow-lg duration-500 flex items-start cursor-pointer"
            ...
            >
              ...
              <div className="ml-auto">
                <button
                  onClick={() => openAddEditForm(employee)}
