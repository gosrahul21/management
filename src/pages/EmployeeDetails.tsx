        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-800 p-6 rounded-lg shadow-md flex flex-col md:flex-row items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-300">DOB: {moment(employee.dob).format('LL')}</p>
              <p className="text-gray-300">Gender: {employee.gender}</p>
              <div className='flex'>
                <img src={WhatsappIcon} className='h-8 w-8 cursor-pointer' onClick={sendMessageOnWhatsApp} alt="Send WhatsApp Message" />
              </div>
            </div>
            <div className="ml-auto">
              <QRCode value={employee.username} size={64} bgColor="#ffffff" fgColor="#000000" />
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <div>
              ...
              <p className={`text-lg ${employee.status === 'Active' ? 'text-green-400' : 'text-red-500'}`}>
                Status: {employee.status}
              </p>
              <p className="text-gray-300">Hire Date: {moment(employee.hireDate).format('LL')}</p>
              <p className="text-gray-300">Employee ID: {employee.employeeId}</p>
            </div>
          </div>
        </div>
