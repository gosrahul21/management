...
const AddGroupForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4 bg-dark-primary rounded-lg shadow-md">
      <div className="mb-4">
        <label htmlFor="groupName" className="block text-sm font-medium text-gray-200">Group Name:</label>
        <input
          type="text"
          id="groupName"
          value={groupName}
      ...
      <div className="mb-4">
        <label htmlFor="startTime" className="block text-sm font-medium text-gray-200">Start Time:</label>
        <input
          type="time"
          id="startTime"
          value={startTime}
      ...
      <div className="mb-4">
        <label htmlFor="endTime" className="block text-sm font-medium text-gray-200">End Time:</label>
        <input
          type="time"
          id="endTime"
          value={endTime}
      ...
      <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
        Add Group
      </button>
    </form>
  );
